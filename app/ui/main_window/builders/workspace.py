...
class WorkspaceMixin:
    def _create_main_content(self):
        ...
        self.manual_translate_button = MPushButton(self.tr("Manual Translate"))
        self.manual_translate_button.setEnabled(True)
        self.manual_translate_button.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)
        ...
        header_layout.addWidget(self.manual_translate_button)
